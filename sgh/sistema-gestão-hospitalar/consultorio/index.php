...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#nova-consulta">
        ...
        <div class="card-body p-0">
          <table id="example1" class="table table-striped projects">
              ...
              $marcadas= mysql_query("SELECT * FROM consultas Order By data desc");
              while ($resultado=  mysql_fetch_array($marcadas)){
                echo "<tr><td>$resultado[Id]</td><td><a>$resultado[nome]</a></td><td>$resultado[data]</td><td class='project-actions text-right'><a class='btn btn-primary btn-sm' href='#ver-dados$resultado[Id]' data-toggle='modal'><i class='fas fa-folder'></i> Ver dados</a>
                <a class='btn btn-info btn-sm' href='#nova-consulta-id' data-toggle='modal'><i class='fas fa-'></i> Consultar</a></td></tr>";
              ?>


    <div class="modal fade" id="ver-dados<?php echo $resultado['Id']; ?>">
    ...
    <!-- /.modal -->
        ...
        <!-- MODAL MODAL MODAL -->          
        <div class="modal fade" id="nova-consulta-id">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="consultar.php?id=<?php echo $resultado['Id'];?>" method="POST">   
              <label for="inputName" class="sr-only">Nome</label>
              <input type="text" id="inputEmail" class="form-control" Value="<?php echo $resultado['nome'];?>" name="nome" value="<?php if(isset($_GET['nome'])){$nomeP=$_GET['nome']; echo"$nomeP";} ?>" required autofocus>
              ...
              <input type="text" class="form-control" name="analise" placeholder="Analise(Opcional)">
 ...
 <div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="modal fade" id="nova-consulta">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Registar nova consulta</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
