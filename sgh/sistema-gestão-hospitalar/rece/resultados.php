          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="internacao.php" class="nav-link">
...
<?php 
              ...
              while ($confir=mysql_fetch_array($ver)){
                echo "<tr><td>$confir[ordem]</td><td><a>$confir[nome]</a></td><td class='project-actions text-right'><a class='btn btn-primary btn-sm' href='analise.php?id=$confir[ordem]' ><i class='fas fa-folder'></i> Ver resultados</a></td></tr>"; ?>
           </tbody> 
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <h3><span class="info-box bg-info"> <?php  echo '<br> ID: '. $confir['ordem']; ?></span></h3>
              ...
              <h3><?php  echo '<b>Genero:</b> '. $confir['genero']; ?></h3>
              <h3><?php  echo '<b>Doença :</b> '.  $confir['doenca'];  ?></h3>
              <h3><?php  echo '<b>Descrição :</b> '. $confir['descricao']; ?></h3>
...
<?php  } ?>
 ...
 <div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="modal fade" id="novo-usuario">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Marcar nova consulta</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          ...
          <?php include("marcar_consulta.php"); ?>
          </div>
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
