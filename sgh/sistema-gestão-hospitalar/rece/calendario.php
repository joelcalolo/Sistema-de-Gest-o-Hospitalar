              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    <div class="external-event bg-success">Operações</div>
                    <div class="external-event bg-warning">Realizar</div>
                    <div class="external-event bg-info">Visitar os doentesk</div>
                    <div class="external-event bg-primary">Trocas camas</div>
                    <div class="external-event bg-danger">Revisar as maquinas</div>
                  </div>
                </div>
                <!-- /.card-body -->
              </div>
