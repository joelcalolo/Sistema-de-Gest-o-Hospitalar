<?php
   ...
   $quarto=$_POST["quarto"];
   $cama=$_POST["cama"];
   $descrisao=$select["descricao"];
   $Alta_D= date("d/m/y H:i:s");
   mysql_query("INSERT INTO espera(nome,date,genero,doenca,alta_D) VALUES ('$nomme','$datta','$gennero','$doenca','$Alta_D')", $connect);
          ...
          <div class="col-12">         
            <div class="card">
              <div class="card-header">
                <h2 class="card-title"><b>Tabela de Altas</b></h2>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 while($resultado = mysql_fetch_array($ver2)){
                  echo"<tr><td>$resultado[ordem]</td><td>$resultado[nome]</td><td>$resultado[alta_D]</td><td>$resultado[doenca]</td><td><button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#ver-dados$resultado[ordem]'><i class='far fa-folder'></i> Ver dados</button></td></tr>";
                ?>
                                                  <!--MODAL MODAL MODAL-->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <h3><span class="info-box bg-info"> <?php  echo '<br> ID: '. $resultado['ordem']; ?></span></h3>
              ...
              <h3><?php  echo '<b>Data de Nascimento:</b> '. $resultado['date']; ?></h3>
              <h3><?php  echo '<b>Genero:</b> '.  $resultado['genero'];  ?></h3>
              <h3><?php  echo '<b>Doenca:</b> '. $resultado['doenca']; ?></h3>
              <h3><span class="info-box bg-info"><?php  echo '<b>Descriçao: </b>'. $resultado['descricao']; ?></span></h3>
