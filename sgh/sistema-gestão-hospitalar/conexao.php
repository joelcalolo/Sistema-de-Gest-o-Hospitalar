...
$intercont= mysql_query("SELECT * FROM internados");
$malogrados= mysql_query("SELECT * FROM nados_mortos");
$nascidos= mysql_query("SELECT * FROM nascidos");
$visitas= mysql_query("SELECT * FROM visitas");
$historico_v= mysql_query("SELECT * FROM historico_visitas");
$usuarios= mysql_query("SELECT * FROM user");
