          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="visitas.php" class="nav-link active">
              ...
              <?php while ($confir= mysql_fetch_array($visitas)){ ?>
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ver-dados">
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>10:12:12</td>
              <td>12:12:21</td>
              <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#historico-visitas-dados">
                <i class="fas fa-folder"></i>
                Ver dados
              </button></td>
            </tr>
